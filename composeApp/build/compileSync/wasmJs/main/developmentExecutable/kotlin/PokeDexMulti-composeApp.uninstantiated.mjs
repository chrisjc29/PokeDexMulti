...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './PokeDexMulti-composeApp.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./PokeDexMulti-composeApp.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
